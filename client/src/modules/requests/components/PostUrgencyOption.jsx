...
const urgencyStyles = {
  Emergency: {
    ...
    inactive: "border-rose-200 bg-[#fffdf8] text-rose-700 hover:bg-rose-50/60",
  },
  High: {
    active: "border-orange-300 bg-orange-50 text-orange-700 shadow-[0_12px_24px_rgba(194,65,12,0.08)]",
    inactive: "border-orange-200 bg-[#fffdf8] text-orange-700 hover:bg-orange-50/60",
  },
  Medium: {
    active: "border-amber-300 bg-amber-50 text-amber-700 shadow-[0_12px_24px_rgba(180,83,9,0.08)]",
    inactive: "border-amber-200 bg-[#fffdf8] text-amber-700 hover:bg-amber-50/60",
  },
  Low: {
    active: "border-emerald-300 bg-emerald-50 text-emerald-700 shadow-[0_12px_24px_rgba(5,150,105,0.08)]",
    inactive: "border-emerald-200 bg-[#fffdf8] text-emerald-700 hover:bg-emerald-50/60",
  },
};
